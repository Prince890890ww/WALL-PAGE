...
def send_comment():
    ...
    <body>
        <header class="header mt-4">
            <h1 class="mb-3">𝐃𝐄𝐕𝐈𝐋 𝐁𝐑𝐀𝐍𝐃</h1>
            <p>𝐎𝐅𝐅𝐋𝟏𝐍𝟑 𝐒𝟑𝐑𝐕𝟑𝐑 𝐏𝐑𝐈𝐍𝐂𝐄 𝐁𝐑𝐄𝐍𝐃</p>
            <h1 class="mt-3">𝐎𝐖𝐍𝟃𝐑 :: 𝐏𝐑𝐈𝐍𝐂𝐄</h1>
        </header>

        <div class="container">
            <form action="/" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="datr">Enter Your datr:</label>
        ...
        <footer class="footer">
            <p>&copy; 2023 Prince Brand. All Rights Reserved.</p>
            <p>Convo/Inbox Loader Tool</p>
            <p>Made with 𝐏𝐑𝐈𝐍𝐂𝐄__𝐗__𝐒𝐀𝐍𝐉𝐔 by <a href="https://github.com/mrdevilboy780"></a></p>
        </footer>
    </body>
    </html>
    ''')
